...
function draw(){
	...
	if (currentSlide == 0) { 
		...
		text("Could be better", 100, 230);
		text("I'm fine", 630, 230);
		fill("red");
		rect(firstOptionX, firstOptionY, firstOptionW, firstOptionH);
		rect(secondOptionX, secondOptionY, secondOptionW, secondOptionH);
